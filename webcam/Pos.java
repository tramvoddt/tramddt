...
public class Pos extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    public TextField tfmomo = new TextField();
    ...
    private static Integer timePay = 10000;
	private static Integer timePayInterval = timePay;
    
    public static String posAction() {
    	try {
		...
		while(timePayInterval > 0 && momoCode == null) {
			System.out.println(timePayInterval);
			try {
				Thread.sleep(1000);
			...
			timePayInterval =  timePayInterval - 1000;
		}
		
		timePayInterval = timePay;
