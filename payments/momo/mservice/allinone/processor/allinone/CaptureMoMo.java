...
import payments.momo.mservice.allinone.models.CaptureMoMoRequest;
import payments.momo.mservice.allinone.models.CaptureMoMoResponse;
import payments.momo.mservice.allinone.models.PaymentResponse;
...
public class CaptureMoMo extends AbstractProcess<CaptureMoMoRequest, CaptureMoMoResponse> {
    ...
    public static CaptureMoMoResponse process(Environment env, String orderId, String requestId, String amount, String orderInfo, String returnURL, String notifyURL, String extraData) throws Exception {
        try {
            ...
            System.out.println("[CaptureMoMoProcess] "+ exception);
        }
        return null;
    }
...
//            errorMoMoProcess(captureMoMoResponse.getErrorCode());
            ...
            System.out.println("[CaptureMoMoResponse] rawData: " + responserawData + ", [Signature] -> " + signResponse + ", [MoMoSignature] -> " + captureMoMoResponse.getSignature());
            ...
            System.out.println("[CaptureMoMoResponse] "+ exception);
    ...
    public CaptureMoMoRequest createPaymentCreationRequest(String orderId, String requestId, String amount, String orderInfo,
        ...
        try {
            ...
            System.out.println("[CaptureMoMoRequest] rawData: " + requestRawData + ", [Signature] -> " + signRequest);
            ...
            System.out.println("[CaptureMoMoRequest] "+ e);
        }
     ...
     * Used for two payments.momomands: captureMoMoWallet and payWithATM
    ...
    public PaymentResponse resultCaptureMoMoWallet(PaymentResponse paymentResponse) throws Exception {
        ...
        System.out.println("resultCaptureMoMoWallet::partnerRawDataBeforeHash::" + rawData);
        String signature = Encoder.signHmacSHA256(rawData, partnerInfo.getSecretKey());
        System.out.println("resultCaptureMoMoWallet::partnerSignature::" + signature);
        System.out.println("resultCaptureMoMoWallet::momoSignature::" + paymentResponse.getSignature());
